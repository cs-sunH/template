...
def main(argv=None) -> int:
    ...
    # face 阶段 1-6 只做主变体 session_lru_recompute;分发不依赖任何
    # 代码默认值(总改造计划 §9.4:runner 显式传 kv_cache_policy;
    # 构造器 fail-closed 校验)。
    ledger_sink = None
    ...
    summary_row = {
        ...
        # D4 (2026-09-05): 被动驱逐深缺口观测。
        "kv_deep_gap_events": int(getattr(
            getattr(scheduler, "kv_manager", None), "deep_gap_events", 0)),
    }
