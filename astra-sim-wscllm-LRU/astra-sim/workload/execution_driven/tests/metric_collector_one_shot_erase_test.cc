...
// ---------------------------------------------------------------------------
// D (part 1): full-layout mirror of OnlineNode. The ORIGINAL pre-R2 mirror
// proved the two metric flags landed in the former bool tail padding
...
// If a different toolchain changes the numeric value while the mirror
// assert still holds, update the number and re-prove -- that failure mode
// is protective, not an equivalence break.
// ---------------------------------------------------------------------------
struct OnlineNodeLayoutMirror {
