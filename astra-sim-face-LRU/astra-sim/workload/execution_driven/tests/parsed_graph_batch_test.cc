...
void test_max_shape_round_trip() {
    ...
    // sh_2.0 adaptation: hbm_access_mode lives on the TOP-LEVEL OnlineNode
    // (not inside ComputeAttrs); hbm_charge stays inside CommAttrs in this
    // repository's flat schema.
