...
the hook count equals the number of completed nodes (54 ranks x 5 = 270; the 2 extra nodes per rank cover the sh_2.0 self-driven completion chains: AnalyticalRemoteMemory FIFO and LocalHbmBandwidthModel restore DMA).
...
int main(int argc, char* argv[]) {
    ...
    //    (54 ranks x 5 nodes = 270; incl. remote-mem and HBM restore chains);
