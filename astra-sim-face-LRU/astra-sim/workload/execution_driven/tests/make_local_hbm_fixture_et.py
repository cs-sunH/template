...
def main() -> None:
    ...
    # Remote-memory backend config for the restored Sys constructor; the
    # static fixture graph carries no MEM nodes, so the no-expansion shape
    # is sufficient (the backend instance only satisfies the API).
