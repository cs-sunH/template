...
class MetricCollector {
  public:
    ...
    // Side-band restore byte accounting for local HBM KV-restore nodes
    // (doc sec.5.2/9.4): Workload::issue_local_hbm_kv_restore calls this on
    // every restore node issue; the LocalHbmBandwidthModel runtime counters
    // track the same bytes as served.
