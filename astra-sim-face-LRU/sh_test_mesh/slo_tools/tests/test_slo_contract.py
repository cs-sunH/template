...
class KvHitStateMappingTests(unittest.TestCase):
    ...
    def test_face_tiered_extraction_and_reconcile(self):
        ...
        run_dir = synthetic.make_run_dir("kvface")
        ...
        records = [
            ...
            # r2：LOCAL_HIT（local_hit 段无物理搬移，不产事件）。
            {"kind": "prefill", "request_id": "r2", "tick": 3,
             "decision": {
                 ...
                 "history_transfer_bytes": 0,
                 "history_transfers": [
                     {"kind": "local_hit", "reason": "history_local_reuse",
                      "session_id": "s2", "total_bytes": 300,
                 ...
                 "admission_evictions": [],
                 "decode_target_evictions": []}},
            # decode：PD 契约行列表（noc_migrate 段产事件）。
            {"kind": "decode", "request_id": "r2", "tick": 4,
             "decision": {
            ...
            # completion：契约行 completion_eviction_transfers。
            {"kind": "completion", "request_id": "r2", "tick": 5,
             "decision": {"completion_eviction_transfers": [
                 {"kind": "remote_store",
        ...
        synthetic.write_metrics_manifest(
            ...
            [synthetic.manifest_request("r0", "s0", 0, 0),
             ...
             synthetic.manifest_request("r2", "s2", 0, 2)],
        ...
        # 镜像不双计）+ PD noc 300 + completion 契约 50；local_hit 不产。
        self.assertEqual(causes, [
            ...
            ("300", "prefill_decode_transfer:noc_migrate:"
        ...
        self.assertIn("history_location_before=partial_hbm_remote",
                      evidence["r1"])
        self.assertIn("history_location_before=local_hbm", evidence["r2"])
