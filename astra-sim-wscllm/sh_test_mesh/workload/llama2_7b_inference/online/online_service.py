...
def main(argv=None) -> int:
    ...
    # 阶段 7 §10.6:strategy 模式按 config.kv_cache_policy 分发——唯一保留
    # 变体 session_lru_recompute -> WscLlmOnlineScheduler;其余取值 fail-
    # closed 报错(legacy 与 relevant 两个历史变体已于 2026-09-05 随
    # A.5 方案清除)。
