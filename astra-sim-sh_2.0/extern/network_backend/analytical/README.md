...
## Overview
Analytical network simulator models communications over multi-dimensional topologies through analytical equations. Currently, the `congestion_aware` analytical network simulator is supported.
