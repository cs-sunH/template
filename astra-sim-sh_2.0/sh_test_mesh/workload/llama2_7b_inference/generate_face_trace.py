    ...
    *,
    ...
    manifest = {
        ...
        "decode_policy": {
            ...
            "admission": (
                "final KV fits per rank after reclaiming completed inactive "
                "sessions; local Prefill instance requires only Decode growth"
            ),
            "lut_match": "exact instance_size,p_chunk,d_batch; nearest d_token",
            "cost": "(T_prime-T)/instance_size",
            "tie_break": (
                "max_remaining_hbm_capacity_bytes_then_trace_config_order"
            ),
        },
        "lut": {
            "path": str(lut_path),
