...
(sidecar_restore double-file form) for the sh_2.0 repository.
...
Derivation rules (frozen 3-minute lineage, template_back/history/20_3mins):
  ...
  2. queue keeps source prefill_length (NEW tokens only, prefix NOT folded in)
     and emits the context sidecar delivering prefix_tokens = source
