#!/usr/bin/env python3
"""B4/WP9 fallback: train-interpolated first-token proxy unit tests (S1).

Covers the B3_S1 60s gate-2 failure fallback implemented in
...
class ModelBytesTests(unittest.TestCase):
    def test_authoritative_conversions(self):
        ...
        # test_face_scheduler.py:346 freezes estimate_model_weight_bytes at
